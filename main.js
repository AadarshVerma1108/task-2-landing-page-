...
ScrollReveal().reveal(".tutor_image img", {
  ...scrollRevealOption,
  origin: "right",
});
ScrollReveal().reveal(".tutor_content .tutor_header", {
  ...scrollRevealOption,
  delay: 500,
});
ScrollReveal().reveal(".tutor_content .tutor_description", {
  ...scrollRevealOption,
  delay: 1000,
});
ScrollReveal().reveal(".tutor_list li", {
  ...scrollRevealOption,
  delay: 1500,
  interval: 500,
});
